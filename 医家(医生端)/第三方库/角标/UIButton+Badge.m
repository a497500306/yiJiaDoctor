...
- (void)badgeInit
{
    ...
    self.badgeBGColor   = [UIColor colorWithRed:35/255.0 green:140/255.0 blue:240/255.0 alpha:1];
...
- (void)updateBadgeFrame
{
    ...
    if (self.badgeValue.length == 1 ) {
        self.badge.frame = CGRectMake(self.badgeOriginX, self.badgeOriginY, minWidth + padding + 1, minHeight + padding);
    }else if (self.badgeValue.length == 2){
        self.badge.frame = CGRectMake(self.badgeOriginX - 3, self.badgeOriginY, minWidth + padding + 5, minHeight + padding);
    }else if (self.badgeValue.length == 3){
        self.badge.frame = CGRectMake(self.badgeOriginX - 9, self.badgeOriginY, minWidth + padding + 8, minHeight + padding);
    }else{
        self.badge.frame = CGRectMake(self.badgeOriginX, self.badgeOriginY, minWidth + padding + 1 , minHeight + padding);
    }
